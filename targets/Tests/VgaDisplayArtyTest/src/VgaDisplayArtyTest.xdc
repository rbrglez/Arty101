...
set_false_path -from [get_clocks {clk_out1_clk31_5MHz}] -to [get_clocks {sys_clk_pin}]
set_false_path -from [get_clocks {sys_clk_pin}] -to [get_clocks {clk_out1_clk31_5MHz}]
